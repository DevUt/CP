...
void solve(int test_case)
{
    ...
    auto check = [&](double length)
    {
        ll sum = 0;
        for (int ropeLength : v)
        {
            sum += ((double)ropeLength / length);
        }
    ...
    cout << std::fixed << std::setprecision(7) << l;
    // cout<<"Case #"<<test_case<<": ";
}
